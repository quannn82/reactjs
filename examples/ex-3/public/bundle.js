...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Note = __webpack_require__(19);
	var InputNote = __webpack_require__(20);
	  ...
	  _createClass(List, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(InputNote, { add: this.addNote }),
	        this.state.mang.map(function (v, i) {
	          return React.createElement(
	            Note,
	            { key: i, remove: _this2.deleteNote, index: i },
	            v
	          );
	        })
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputNote = function (_React$Component) {
	  _inherits(InputNote, _React$Component);

	  function InputNote(props) {
	    _classCallCheck(this, InputNote);

	    var _this = _possibleConstructorReturn(this, (InputNote.__proto__ || Object.getPrototypeOf(InputNote)).call(this, props));

	    _this.addNote = _this.addNote.bind(_this);
	    return _this;
	  }

	  _createClass(InputNote, [{
	    key: 'addNote',
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement('input', { type: 'text', placehoder: 'Enter your note ...', ref: 'inpNote' }),
	        React.createElement(
	          'button',
